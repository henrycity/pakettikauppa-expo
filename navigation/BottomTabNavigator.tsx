...
export default function BottomTabNavigator(): JSX.Element {
  ...
  // Without authHasLoaded navigating to restricted urls will fail
  //   because isAuthorized() returns false initially
  const { authHasLoaded, isAuthorized } = useAuthorization()
  return (
    <>
      {authHasLoaded ? (
        <BottomTab.Navigator
